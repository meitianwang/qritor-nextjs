...
SET @method_id = (SELECT id FROM novel_creation_method WHERE name_zh = '幕后黑手流 / 编剧流' LIMIT 1);
...
) ON DUPLICATE KEY UPDATE description_zh = VALUES(description_zh), json_schema_zh = VALUES(json_schema_zh), updated_at = NOW();
