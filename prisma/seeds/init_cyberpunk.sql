...
SET @method_id = (SELECT id FROM novel_creation_method WHERE name = '赛博朋克小说创作' LIMIT 1);
...
-- 2.2 世界观设定（setting, singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '世界观设定',
...
-- 2.3 科技与义体体系（setting, singleton, temp=0.9）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '科技与义体体系',
...
-- 2.4 势力格局（setting, singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '势力格局',
