...
SET @method_id = (SELECT id FROM novel_creation_method WHERE name = '悬疑推理小说创作' LIMIT 1);
...
-- 2.2 主角设定（setting, singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '主角设定',
...
-- 2.3 世界背景（setting, singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '世界背景',
...
-- 2.4 阴谋框架（setting, singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '阴谋框架',
...
-- 2.6 角色（character, 非singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '角色',
...
-- 2.7 案发地点（scene, 非singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '案发地点',
...
-- 2.8 势力（organization, 非singleton, temp=1.0）
INSERT INTO module_type (name, description, json_schema, temperature, novel_creation_method_id, enable_ai, singleton, built_in, entity_category, created_at)
VALUES (
  '势力',
