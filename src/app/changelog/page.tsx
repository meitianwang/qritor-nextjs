    ...
    sections: [
      {
        ...
        items: [
          "changelog.entries.v1_0_1.improved.item1",
          "changelog.entries.v1_0_1.improved.item2",
        ],
      },
      {
        type: "fixed",
    ...
    case "new":
      return (
        <svg
          ...
          stroke="currentColor"
          strokeWidth="2"
          style={{ color: "var(--color-accent-teal-light)" }}
        >
      ...
      <section className="changelog-hero">
        <div className="container">
          <div className="changelog-hero-content">
            <h1 className="changelog-hero-title">{t("changelog.heroTitle")}</h1>
          ...
          <div className="changelog-timeline-container">
            {changelogData.map((entry, index) => (
              <article key={index} className="changelog-entry">
                ...
                {/* Update title */}
                <h2 className="changelog-entry-title">{t(entry.title)}</h2>
