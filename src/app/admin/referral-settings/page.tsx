    ...
    return (
        <div className="admin-page payment-settings-page">
            ...
            {settings.inviterReward === null && (
                <div className="alert alert-error">
                    <span className="alert-icon">&#9888;&#65039;</span>
                    邀请奖励配置未初始化！请填写以下配置并保存，或执行数据库初始化脚本: <code>migrations/init_system_config.sql</code>
                </div>
            )}
                ...
                <div className="settings-form">
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange('inviterReward', e.target.value)}
                            min="0"
                            placeholder="请输入数值"
                        />
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange('inviteeReward', e.target.value)}
                            min="0"
                            placeholder="请输入数值"
                        />
                ...
                <div className="settings-form">
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange('milestoneCount', e.target.value)}
                            min="1"
                            placeholder="请输入数值"
                        />
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange('milestoneReward', e.target.value)}
                            min="0"
                            placeholder="请输入数值"
                        />
            ...
            <div className="settings-card settings-info">
                <h3>&#128161; 配置说明</h3>
                <ul>
                    <li><strong>基础奖励</strong>：每次成功邀请后，邀请人和被邀请人各自获得的积分</li>
                    <li><strong>里程碑奖励</strong>：累计邀请达到指定人数后的额外奖励</li>
                    <li><strong>月度限制</strong>：防止滥用，每月最多可获得奖励的邀请人数</li>
