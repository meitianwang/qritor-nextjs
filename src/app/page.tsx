      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions animate-fade-in delay-300">
            ...
            <Link
              href="/download"
              className="btn btn-secondary btn-large btn-press"
            >
        ...
        <div className="container">
            ...
            <div className="feature-grid">
              <div className="feature-content">
                <span className="feature-tag">
                  {t("landing.features.aiWriting.tag")}
                </span>
                <h2 className="feature-title">
                  {t("landing.features.aiWriting.title")}
                </h2>
                <p className="feature-description">
                  {t("landing.features.aiWriting.description")}
                </p>
              </div>
              <div className="feature-visual hover-lift glow-effect">
                <div className="feature-visual-glow"></div>
                <Image
                  src="/images/features/ai_writing_assistant.png"
                  alt={t("landing.features.aiWriting.title")}
          ...
          <div className="feature-section">
            <div className="feature-grid">
              <div className="feature-content">
                <span className="feature-tag">
                  {t("landing.features.creationMethod.tag")}
                </span>
                <h2 className="feature-title">
                  {t("landing.features.creationMethod.title")}
                </h2>
                <p className="feature-description">
                  {t("landing.features.creationMethod.description")}
                </p>
              </div>
              <div className="feature-visual hover-lift glow-effect">
                <div className="feature-visual-glow"></div>
                <Image
                  src="/images/features/creation_method.png"
                  alt={t("landing.features.creationMethod.title")}
                  className="feature-image"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
          ...
          <div className="feature-section">
            <div className="feature-grid">
              <div className="feature-content">
                <span className="feature-tag">
                  {t("landing.features.plotEngine.tag")}
                </span>
                <h2 className="feature-title">
                  {t("landing.features.plotEngine.title")}
                </h2>
                <p className="feature-description">
                  {t("landing.features.plotEngine.description")}
                </p>
              </div>
              <div className="feature-visual hover-lift glow-effect">
                <div className="feature-visual-glow"></div>
                <Image
                  src="/images/features/plot_engine.png"
                  alt={t("landing.features.plotEngine.title")}
                  className="feature-image"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
          ...
          <div className="feature-section">
            <div className="feature-grid">
              <div className="feature-content">
                <span className="feature-tag">
                  {t("landing.features.dynamicGraph.tag")}
                </span>
                <h2 className="feature-title">
                  {t("landing.features.dynamicGraph.title")}
                </h2>
                <p className="feature-description">
                  {t("landing.features.dynamicGraph.description")}
                </p>
              </div>
              <div className="feature-visual hover-lift glow-effect">
                <div className="feature-visual-glow"></div>
                <Image
                  src="/images/features/dynamic_graph.png"
                  alt={t("landing.features.dynamicGraph.title")}
                  className="feature-image"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
          ...
          <div className="feature-section">
            <div className="feature-grid">
              <div className="feature-content">
                <span className="feature-tag">
                  {t("landing.features.skillSystem.tag")}
                </span>
                <h2 className="feature-title">
                  {t("landing.features.skillSystem.title")}
                </h2>
                <p className="feature-description">
                  {t("landing.features.skillSystem.description")}
                </p>
              </div>
              <div className="feature-visual hover-lift glow-effect">
                <div className="feature-visual-glow"></div>
                <Image
                  src="/images/features/skill_system.png"
                  alt={t("landing.features.skillSystem.title")}
                  className="feature-image"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
      ...
      <section className="cta-starfield">
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <a href={downloadUrl} className="btn btn-white btn-large" download>
              {userOS === "mac" ? (
                <svg
                  width="18"
                  height="18"
