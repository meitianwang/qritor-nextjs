...
- **建议您每写完一两个章节，就通过创作助手或点击[编辑器工具栏](/docs/zh/user-guide/editor-toolbar)中的信息提取工具**，实时执行以下维护：
...
- **We highly recommend using the creative AI assistant or the [extraction tools](/docs/en/user-guide/editor-toolbar)** in the editor toolbar after every chapter or two to continuously:
