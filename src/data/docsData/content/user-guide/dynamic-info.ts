...
这是最高效的方式。写完一章后，在右侧 AI 助手工具栏中点击 **「提取动态信息」** 按钮：
...
This is the most efficient method. After finishing a chapter, click the **"Extract Dynamic Info"** button in the AI assistant toolbar on the right:
