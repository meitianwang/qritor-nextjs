...
先在编辑器中**选中一段文本**，然后点击 AI 助手工具栏中的 **「润色」** 按钮（快捷键 Cmd+P / Ctrl+P），或在右键菜单中选择 **「润色」**。
...
First **select a passage of text** in the editor, then click the **"Polish"** button in the AI assistant toolbar (shortcut Cmd+P / Ctrl+P), or choose **"Polish"** from the right-click menu.
