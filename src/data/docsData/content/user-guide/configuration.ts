...
切换到**快捷键**标签页，可以查看和自定义所有可用的键盘快捷键。快捷键分为三组：
...
Switch to the **Shortcuts** tab to view and customize all available keyboard shortcuts. Shortcuts are organized into three groups:
