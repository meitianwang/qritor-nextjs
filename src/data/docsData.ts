...
- **积分包**：后续将推出单独购买的积分包（敬请期待）。
        ...
        'plans': {
            title: '定价',
            description: 'Qritor 提供四个订阅方案，均为月度自动续费。所有功能消耗以 Credits 计算。',
            body: `
## 个人方案
...
- **Credit packs**: Standalone credit packs will be available soon.
        ...
        'plans': {
            title: 'Plans',
            description: 'Qritor offers four subscription tiers, all billed monthly with auto-renewal. All usage is measured in Credits.',
            body: `
## Individual Plans
...
- Editor toolbar (continue, polish, information extraction, quality assessment, etc.)
...
- **Credit validity**: Subscription credits are valid for the current cycle (30 days) and do not roll over.
        ...
        billing: {
            title: 'Billing',
            description: 'Learn about billing cycles, payment methods, subscription management, and refund policies in Qritor.',
            body: `
## Manage Subscription
